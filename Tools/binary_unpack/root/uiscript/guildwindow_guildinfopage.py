...
if app.ENABLE_SECOND_GUILDRENEWAL_SYSTEM:
	...
	if app.ENABLE_GUILD_DONATE_ATTENDANCE:
		ATTENDANCE_ROOT = "d:/ymir work/ui/game/guild/guildattendance/"
	PLUS_WITDH = 80
	PLUS_RIGHT_WITDH = 40
	PLUS_LEFT_WITDH = 40
	window = {
...
if app.ENABLE_GUILD_DONATE_ATTENDANCE:
	window["children"] = window["children"] + (
		## Donate Button
		{
			...
			"x" : 5 + 100,
			"y" : 276,
			"default_image" : ATTENDANCE_ROOT+"attendance_button_default.sub",
			"over_image" : ATTENDANCE_ROOT+"attendance_button_over.sub",
			"down_image" : ATTENDANCE_ROOT+"attendance_button_down.sub",
		},
	)
