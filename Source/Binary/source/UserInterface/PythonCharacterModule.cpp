...
PyObject *chrIsMount(PyObject *poSelf, PyObject *poArgs)
{
	int iVirtualID;
	if (!PyTuple_GetInteger(poArgs, 0, &iVirtualID))
		return Py_BuildException();
	...
	return Py_BuildValue("i", pInstance->IsMount());
}
...
PyObject *chrGetProjectPosition(PyObject *poSelf, PyObject *poArgs)
{
	...
	float fx, fy, fz;
	rpyGraphic.ProjectPosition(PixelPosition.x, -PixelPosition.y, PixelPosition.z + float(iHeight), &fx, &fy, &fz);
...
void initchr()
{
	static PyMethodDef s_methods[] =
	{
		...
		{ "IsMount",					chrIsMount,							METH_VARARGS },
	...
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_1", CRaceMotionData::NAME_EMOTION_1);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_2", CRaceMotionData::NAME_EMOTION_2);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_3", CRaceMotionData::NAME_EMOTION_3);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_4", CRaceMotionData::NAME_EMOTION_4);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_5", CRaceMotionData::NAME_EMOTION_5);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_6", CRaceMotionData::NAME_EMOTION_6);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_7", CRaceMotionData::NAME_EMOTION_7);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_8", CRaceMotionData::NAME_EMOTION_8);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_9", CRaceMotionData::NAME_EMOTION_9);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_10", CRaceMotionData::NAME_EMOTION_10);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_11", CRaceMotionData::NAME_EMOTION_11);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_12", CRaceMotionData::NAME_EMOTION_12);
	
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_13", CRaceMotionData::NAME_EMOTION_13);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_14", CRaceMotionData::NAME_EMOTION_14);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_15", CRaceMotionData::NAME_EMOTION_15);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_16", CRaceMotionData::NAME_EMOTION_16);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_17", CRaceMotionData::NAME_EMOTION_17);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_18", CRaceMotionData::NAME_EMOTION_18);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_19", CRaceMotionData::NAME_EMOTION_19);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_20", CRaceMotionData::NAME_EMOTION_20);
	PyModule_AddIntConstant(poModule, "MOTION_EMOTION_21", CRaceMotionData::NAME_EMOTION_21);
	...
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_AUTO_PICK_UP", CInstanceBase::NEW_AFFECT_AUTO_PICK_UP);
#endif
