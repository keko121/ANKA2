...
#ifdef __AUTO_HUNT__
		void SetAutoHuntRange(bool bStatus) { m_bAutoHuntRageStatus = bStatus; }
...
#ifdef ENABLE_MINIMAP_SMOOTH_ZOOM
	private:
		void __StartZoomProcess();
		bool __IsZoomProcess() const;

	private:
		float m_fTargetZoom;
		DWORD m_dwZoomBeginTime;
		DWORD m_dwZoomEndTime;
#endif
};