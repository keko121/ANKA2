...
{
	if (m_eRace >= 30000 && m_eRace <= 30020)
		return true;
	return false;
}
#endif
...
{
	if (TYPE_GROWTH_PET == m_eActorType)
		return true;
...
void CActorInstance::ChangeSkillColor(const DWORD * c_dwSkillColor)
{
	memcpy(m_dwSkillColor, c_dwSkillColor, sizeof(m_dwSkillColor));
}
#endif
