...
{
	public:
		CStreamData(LPDIRECT3DVERTEXBUFFER8 pStreamData = nullptr, UINT Stride = 0) : m_lpStreamData(pStreamData), m_Stride(Stride)
		{
		}
...
{
	public:
		CIndexData(LPDIRECT3DINDEXBUFFER8 pIndexData = nullptr, UINT BaseVertexIndex = 0)
