...
void CPlaneCollisionInstance::Render(D3DFILLMODE)
{
	...
	s.RenderBox(m_attribute.trans, m_attribute.size, D3DFILL_WIREFRAME);
}
...
void CCylinderCollisionInstance::Render(D3DFILLMODE d3dFillMode)
{
	...
	s.RenderCylinder(nullptr, m_attribute.v3Position.x, m_attribute.v3Position.y, m_attribute.v3Position.z, m_attribute.fRadius, m_attribute.fHeight, d3dFillMode);
}
