...
// =============================================================================
// Platform Detection for Unix-like systems
// =============================================================================
// Linux: epoll (default) - do NOT define __USE_SELECT__
// FreeBSD: kqueue (default) - do NOT define __USE_SELECT__
// Cygwin/Other: select fallback
// =============================================================================

#if defined(__linux__)
    // Linux uses epoll by default (defined in fdwatch.h)
    // Do NOT define __USE_SELECT__ unless explicitly needed
#elif defined(__FreeBSD__)
    // FreeBSD uses kqueue by default
    // Do NOT define __USE_SELECT__
#else
    // Fallback to select for other platforms
    #define __USE_SELECT__
    #ifdef __CYGWIN__
