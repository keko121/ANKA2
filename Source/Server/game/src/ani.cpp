...
bool ANI::load()
{
	const char*	dir_name[MAIN_RACE_MAX_NUM] = {
		"data/pc/warrior",		// Savaþçý (m)
		"data/pc/assassin",		// Ninja (w)
		"data/pc/sura",			// Sura (m)
		"data/pc/shaman",		// Þaman (w)
		"data/pc2/warrior",		// Savaþçý (w)
		"data/pc2/assassin",	// Ninja (m)
		"data/pc2/sura",		// Sura (w)
		"data/pc2/shaman",		// Þaman (m)
	};
