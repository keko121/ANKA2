...
namespace marriage
{
	struct TWeddingInfo
	{
		...
		DWORD dwPID1;
		DWORD dwPID2;
		TWeddingInfo(DWORD time, DWORD pid1, DWORD pid2) : dwTime(time), dwPID1(pid1), dwPID2(pid2) {}
	};
	...
	struct TWedding
	{
		...
		TWedding(DWORD time, DWORD dwMapIndex, DWORD pid1, DWORD pid2) : dwTime(time), dwMapIndex(dwMapIndex), dwPID1(pid1), dwPID2(pid2) {}
	};
