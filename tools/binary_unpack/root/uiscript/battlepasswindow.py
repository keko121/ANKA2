	...
	(
		{
			...
			"title" : uiScriptLocale.EXTENDED_BATTLE_PASS_TITLE,
			"children" :
			(
				## Background Area
				{
							...
							(
								{
									...
									"children" :
									( { "name" : "NormalInfoText2", "type" : "text", "x" : 0, "y" : -1, "all_align" : "center", "fontsize" : "LARGE", "color" : 0xFFFFFFFF, "outline" : 1, "text" : "Bilgi Tablosu", }, ),
								},
								{
									"name" : "NormalTextInfo",
								...
								},
								{
									...
									(
										...
										},
										{
											...
											"text" : uiScriptLocale.EXTENDED_BATTLE_PASS_CURRENT_SEASON, "fontsize" : "LARGE", "color" : 0xFFFFFFFF, "outline" : 1,
										},
										{
											"name" : "InputTicketInfoTimeText2", "type" : "text",
											"x" : 0, "y" : -46, "all_align" : "center",
											"text" : "01.01.2023 01:00:00 - 01.03.2023 23:59:59", "fontsize" : "LARGE", "color" : 0xFFFFFFFF, "outline" : 1,
										},
										{
											"name" : "InputTicketInfoText", "type" : "text",
											"x" : 0, "y" : -15, "all_align" : "center",
											"text" : uiScriptLocale.EXTENDED_BATTLE_PASS_ACTIVATE_PREMIUM, "fontsize" : "LARGE", "color" : 0xFFFFFFFF, "outline" : 1,
										},
										## ItemSlot
										{
										...
										},
										{
											...
											"text" : uiScriptLocale.EXTENDED_BATTLE_PASS_ACTIVATE_PREMIUM,
									...
									(
										{
											...
											"x" : 0, "y" : 3,
											"text" : uiScriptLocale.EXTENDED_BATTLE_PASS_MISSION_NAME,
											...
											(
												{
													...
													"x" : 5, "y" : 0,
													"text" : uiScriptLocale.EXTENDED_BATTLE_PASS_MISSION_STATUS,
													"fontsize" : "LARGE",
											...
											(
												{
													...
													"x" : 5, "y" : 0,
													"text" : uiScriptLocale.EXTENDED_BATTLE_PASS_MISSION_INFO,
													"fontsize" : "LARGE",
													"color" : 0xFFFEE3AE, "outline" : 1,
												},
											),
											...
											(
												{
													...
													"x" : 5, "y" : 0,
													"text" : uiScriptLocale.EXTENDED_BATTLE_PASS_DESCRIPTION,
													"fontsize" : "LARGE",
													"color" : 0xFFFEE3AE, "outline" : 1,
												},
											),
							...
							(
								{
									...
									(
											...
											(
												{
													...
													"x" : 38, "y" : 4, "outline" : 1,
													"text" : uiScriptLocale.EXTENDED_BATTLE_PASS_SEASON_DATE_FROM,
												},
												{
												...
												},
												{
													...
													"x" : 38, "y" : 20, "outline" : 1, 
													"text" : uiScriptLocale.EXTENDED_BATTLE_PASS_SEASON_DATE_TO,
												},
												{
										...
										},
										{
											...
											"x" : 0, "y" : 120, "outline" : 1,
											"horizontal_align" : "center", "text_horizontal_align" : "center",
											"text" : uiScriptLocale.EXTENDED_BATTLE_PASS_SEASON_PROGRESS, "outline" : 1,
										},
										{
