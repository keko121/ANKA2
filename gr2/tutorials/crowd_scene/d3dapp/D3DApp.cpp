...
// NB: We happen to know that we'll link with win32_granny.rc, which
//  has the main granny icon at 101.
#define GRANNY_ICON 101
...
HRESULT CD3DApplication::Create( HINSTANCE hInstance )
{
    ...
    if( m_hWnd == NULL)
    {
        ...
        WNDCLASS wndClass = { 0, WndProc, 0, 0, hInstance,
                              LoadIcon( hInstance, MAKEINTRESOURCE(GRANNY_ICON) ),
